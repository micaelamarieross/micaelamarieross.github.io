...
void loop() {
  ...
  } else if(5 < distance && distance < 60){  //if the object is a medium distance
  ...
  } else if(distance > 60){  //if the object is far away
  ...
  } else{                     //anything else just make it clear
    
    //make the RGB LED clear
    analogWrite(redPin, 0);
    analogWrite(greenPin, 0);
    analogWrite(bluePin, 0);    
  }
